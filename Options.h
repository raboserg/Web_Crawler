...
public:
  ...
  void command_processor(Command_Processor *);*/
	std::shared_ptr<Command_Processor> command_processor(void) const;
	void command_processor(std::shared_ptr<Command_Processor>);
	
  // = Get/set the <URL_Visitor>.
	/*URL_Visitor *visitor(void) const;
  void visitor(URL_Visitor *);*/

	std::shared_ptr<URL_Visitor> visitor(void) const;
	void visitor(std::shared_ptr<URL_Visitor>);
...
private:
  ...
  //Command_Processor *command_processor_;
	std::shared_ptr<Command_Processor> command_processor_;

  /// Pointer to the <URL_Visitor>.
	std::shared_ptr<URL_Visitor> visitor_;
